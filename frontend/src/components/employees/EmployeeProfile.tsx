                ...
                <Stack spacing={2}>
                  ...
                  <Stack direction="row" alignItems="center" spacing={2}>
                    ...
                    <Box>
                      ...
                      <Typography variant="body1">{employee.phone_number || 'Not provided'}</Typography>
                    </Box>
                  </Stack>
                  <Stack direction="row" alignItems="center" spacing={2}>
              ...
              <Paper sx={{ p: 3 }}>
                ...
                <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body1">{employee.address?.street || employee.address_line1 || 'Not provided'}</Typography>
                  </Box>
                </Stack>
              </Paper>
            </Box>
              ...
              <Paper sx={{ p: 3 }}>
                ...
                <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    <Typography variant="body1">{employee.status || 'Active'}</Typography>
                  </Box>
                  <Box>
