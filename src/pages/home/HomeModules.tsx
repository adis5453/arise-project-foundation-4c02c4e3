      ...
      <div className="mx-auto max-w-7xl px-6 py-20 2xl:max-w-[1400px] 2xl:px-10">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {MODULES.map(({ icon: Icon, label }) => (
                <div
                  key={label}
                  className="flex items-center gap-3 rounded-2xl border border-border/60 bg-background/60 px-4 py-3 shadow-denim-sm backdrop-blur"
                >
          ...
          <div className="grid gap-4">
            <div className="rounded-3xl border border-border/60 bg-background/60 p-6 shadow-denim-sm backdrop-blur">
