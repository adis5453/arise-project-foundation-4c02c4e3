  ...
  return (
    <div className="relative">
      ...
      <div className="relative rounded-[2.5rem] border border-border bg-card/50 p-3 shadow-denim-lg backdrop-blur">
        <div className="rounded-[2.2rem] border border-border bg-background/40 p-4 sm:p-5">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-[1.15fr_0.85fr]">
            <div className="rounded-2xl border border-border bg-background/60 p-4">
              ...
              <div className="mt-3 grid gap-2">
                {QUEUE.map((item) => (
                  <div key={item.title} className="rounded-xl border border-border bg-card/60 px-3 py-2">
