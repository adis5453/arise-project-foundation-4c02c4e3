...
export function HomeProductPreview() {
  return (
    <div className="relative">
      ...
      <div className="relative rounded-[2.2rem] border border-border/25 bg-card/50 p-3 shadow-denim-lg backdrop-blur">
        <div className="rounded-[1.9rem] border border-border/20 bg-background/55 p-4">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-3">
            {STATS.map(({ icon: Icon, label, value }) => (
              <div key={label} className="rounded-2xl border border-border/20 bg-card/40 p-4 shadow-denim-sm">
                <div className="flex items-center justify-between">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-[1.15fr_0.85fr]">
            <div className="rounded-2xl border border-border/20 bg-card/35 p-4 shadow-denim-sm">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-3 grid gap-2">
                {QUEUE.map((item) => (
                  <div key={item.title} className="rounded-xl border border-border/15 bg-background/55 px-3 py-2">
